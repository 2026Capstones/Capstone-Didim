...
CREATE TABLE `company` (
  ...
  `talent_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `culture` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interview_types` json DEFAULT NULL,
  `resume_questions` json DEFAULT NULL,
...
INSERT INTO `company` VALUES ('company-001','삼성전자','기술중심, 글로벌 역량','체계적, 대규모 프로젝트, 전문성 중시','[\"직무적성검사(GSAT)\", \"기술면접\", \"임원면접\"]','[\"삼성 지원동기\", \"직무 관련 경험\", \"본인의 강점과 약점\", \"입사 후 포부\"]','[\"Java\", \"C++\", \"Python\", \"AI/ML\"]','2026-05-27 14:37:58'),('company-002','SK하이닉스','도전중심, 실행력','도전적, 빠른 의사결정, 성과 중시','[\"역량면접\", \"기술면접\", \"인성면접\"]','[\"SK 지원동기\", \"실패 경험과 극복\", \"팀 프로젝트 경험\", \"직무역량\"]','[\"Python\", \"Data분석\", \"AI/ML\", \"반도체 지식\"]','2026-05-27 14:37:58'),('company-003','LG전자','협업중심, 고객가치','수평적, 워라밸 중시, 고객 중심','[\"인성면접\", \"PT면접\", \"직무면접\"]','[\"LG Way 공감\", \"직무역량\", \"성장과정\", \"협업 경험\"]','[\"Java\", \"Spring\", \"React\", \"Node.js\"]','2026-05-27 14:37:58'),('company-004','현대자동차','융합형, 미래모빌리티','도전적, 혁신중심, 글로벌','[\"인성면접\", \"직무면접\", \"토론면접\"]','[\"현대차 지원동기\", \"창의적 문제해결\", \"협업 경험\", \"미래 모빌리티 관심\"]','[\"Python\", \"임베디드\", \"AI\", \"C++\"]','2026-05-27 14:37:58');
...
-- Dump completed on 2026-05-27 14:51:28
